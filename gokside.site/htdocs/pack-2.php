...
<head>
  ...
  <title>Plano Business | Gokside</title>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <p>Para assinar este Plano escolha o método de pagamento.</p>
             <p>
             Antes de assinar o plano faça um teste gratuito por <b>48h</b></p>
             <center>
               <a href="cadastro?p=<?=base64_encode("pack-2")?>" class="buy-btn btn btn-primary">Testar agora</a>
            </center>
            <br>
            <br>
