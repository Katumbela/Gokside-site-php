...
<center style='background: #E1E0E052; width: 100%'>
    <div id="body" style='padding: 1rem 2rem; background: rgba(255, 214, 184, 0.409); max-height: 1200px; max-width: 700px'>
        <br>
        <br>
...
A formação irá decorrer no período   <b> {$hora} </b><br>
    ...
    <div id="body" style='padding: 1rem 2rem; gap: 5px; background: #ff680a; max-height: 1200px; max-width: 700px'>
