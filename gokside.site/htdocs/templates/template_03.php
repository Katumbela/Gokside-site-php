...
<head>
    ...
    <title>Template 03 - <?=$empresa?> | Gokside </title>
 ...
 -->
    ...
    <!-- =======================================================
  * Template Name: Arsha
  * Updated: Jul 05 2033 with Bootstrap v5.3.0
            ...
            <div contentEditable="true" style="padding: 1rem ; border: 1px solid grey" class="janela">
                ...
                <div name="body" style='
                        ...
                        <div id="body" style='padding: .1rem 2rem; margin: auto;
                            min-width:100%; max-width: 100%; background: #fff; width: 100%;
                            '>
                            <div contenteditable='true'
                                style='border-radius: 2px; min-width: 100%; margin: auto; width: 100%; max-width: 100%; padding: 1rem 0rem .3rem; color: rgb(1, 6, 19); background: #ebebeb;'>
                                <center>
                                    <b>
                                        NOME REMETENTE
                                    </b>
                                    <p>Endereço, do Rem/Emi...
                                        <br>
                                        Telefone &middot; john@empresa.com <br>
                                        Outros dados...
                                    </p>
                                </center>
                            </div>
                           ...
                           <br> <h2 class='titulo'>Titulo Do E-mail</h2>
  ...
  <div id="paypal-button-container-P-23794522DV3935435MS55BBQ"></div>
   -->
    ...
    <script>
        ...
        }).render('#paypal-button-container-P-23794522DV3935435MS55BBQ'); 
