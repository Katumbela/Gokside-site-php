...
<head>
    ...
    <title>Template 02 - <?=$empresa?> | Gokside </title>
    ...
    <form action="../gokgok/send_template" method="post">
            ...
            <style>
             ...
             <div id="toolbar">
                ...
                <label>Tamanho da Fonte: <input type="number" id="fontSize" min="10" max="70"></label>
                ...
                <div contentEditable="true" style="padding: 1rem ; border: 1px solid grey" class="janela">
                 ...
                 <div name="body" style='
                        ...
                        <div id="body" style='padding: 2rem; margin: auto;
                            min-width:90%; max-width: 100%; background: #fff; width: 90%;
                            '>
                            <h3><?=$nome . ' &middot; ' . $empresa?></h3>
                            <hr>


                            <h4 class='titulo'>Titulo Do E-mail</h4>
                            ...
                            <p style='writing-mode: sideways-rl;'>
                                ...
                                <br>
                                <br>
                                Copie os titulos para criar novos titulos caso nescessários
                            </p>
                            <br>
                ...
                <div name="body" style='
                        ...
                        <div id="body" style='padding: 2rem; margin: auto;
                            ...
                            <div contenteditable='true'
                                style='border-radius: 10px; min-width: 80%; margin: auto; width: 100%; max-width: 80%; padding: 1rem 0rem .3rem; color: rgb(1, 6, 19); background: #ebebeb;'>
                                <center>
                                    <b>
                                        <?=$empresa?>
                                    </b>
